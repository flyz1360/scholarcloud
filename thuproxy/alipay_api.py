...
verifyURL={
    ...
    "http" :"http://notification.alipay.com/trade/notify_query.do?",
    }
gateway="https://www.alipay.com/cooperate/gateway.do"

class Alipay:
    def __init__(self,
                 partner="2088121355152995",
                 key="ahpiwgblmvj5esw7yaf90xoh1ordiic7",
                 sellermail="scholarcloudpay@163.com",
                 notifyurl="http://www.thucloud.com/pay_callback",
                 returnurl="http://www.thucloud.com/record",
                 showurl="http://www.thucloud.com/record"):
    ...
    def buildSign(self,params):
        ...
        if True:#not isinstance(for_md5, str):
